...
WSGI_APPLICATION = 'hamsukypay.wsgi.application'
...
# HamsukyPay settings
HAMSUKYPAY_SECRET_KEY = os.getenv('HAMSUKYPAY_SECRET_KEY', 'sk_test_yoursecretkey')
HAMSUKYPAY_PUBLIC_KEY = os.getenv('HAMSUKYPAY_PUBLIC_KEY', 'pk_test_yourpublickey')
